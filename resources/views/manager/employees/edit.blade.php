...
@section('content')
    ...
    <div class="top-bar">
        <div class="page-title">
            <h1>Edit Pegawai</h1>
            <p>Ubah informasi dan status pegawai</p>
        </div>
        <div class="user-info">
    ...
    <div class="container">
        ...
        <nav class="breadcrumb">
            ...
            <span class="separator">/</span>
            <span class="current">Edit {{ $employee->name }}</span>
        </nav>
        ...
        <div class="card">
            ...
            <form action="{{ route('manager.employees.update', $employee) }}" method="POST" class="employee-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="employee-info">
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $employee->branch->name ?? 'Tidak ada' }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="status-options">
                                <label class="status-option {{ $employee->is_active ? 'selected' : '' }}">
                                ...
                                <label class="status-option {{ !$employee->is_active ? 'selected' : '' }}">
                                    ...
                                    <div class="status-card inactive">
                                        ...
                                        <div class="status-info">
                                            ...
                                            <div class="status-desc">Pegawai tidak dapat login (keluar/dipecat)</div>
                                        </div>
                                    </div>
                                </label>
                            </div>
                            <small class="form-help">
                                ...
                                Pegawai yang tidak aktif tidak dapat mengakses sistem
                            </small>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelectorAll('input[name="is_active"]').forEach(radio => {
            radio.addEventListener('change', function() {
                if (this.value === '0' && {{ $employee->is_active ? 'true' : 'false' }}) {
                    if (!confirm('Yakin ingin menonaktifkan pegawai ini? Pegawai tidak akan dapat login ke sistem.')) {
